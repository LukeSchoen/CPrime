...
#else
#define	BUILTIN(x)	__cprime_builtin_##x
...
#ifndef __TINYC__
int __builtin_ffs(int x) __attribute__((alias("__cprime_builtin_ffs")));
int __builtin_ffsl(long x) __attribute__((alias("__cprime_builtin_ffsl")));
int __builtin_ffsll(long long x) __attribute__((alias("__cprime_builtin_ffsll")));
int __builtin_clz(unsigned int x) __attribute__((alias("__cprime_builtin_clz")));
int __builtin_clzl(unsigned long x) __attribute__((alias("__cprime_builtin_clzl")));
int __builtin_clzll(unsigned long long x) __attribute__((alias("__cprime_builtin_clzll")));
int __builtin_ctz(unsigned int x) __attribute__((alias("__cprime_builtin_ctz")));
int __builtin_ctzl(unsigned long x) __attribute__((alias("__cprime_builtin_ctzl")));
int __builtin_ctzll(unsigned long long x) __attribute__((alias("__cprime_builtin_ctzll")));
int __builtin_clrsb(int x) __attribute__((alias("__cprime_builtin_clrsb")));
int __builtin_clrsbl(long x) __attribute__((alias("__cprime_builtin_clrsbl")));
int __builtin_clrsbll(long long x) __attribute__((alias("__cprime_builtin_clrsbll")));
int __builtin_popcount(unsigned int x) __attribute__((alias("__cprime_builtin_popcount")));
int __builtin_popcountl(unsigned long x) __attribute__((alias("__cprime_builtin_popcountl")));
int __builtin_popcountll(unsigned long long x) __attribute__((alias("__cprime_builtin_popcountll")));
int __builtin_parity(unsigned int x) __attribute__((alias("__cprime_builtin_parity")));
int __builtin_parityl(unsigned long x) __attribute__((alias("__cprime_builtin_parityl")));
int __builtin_parityll(unsigned long long x) __attribute__((alias("__cprime_builtin_parityll")));
#endif
