...
The existing harness compares shared C cases against vendored TCC; the full CPC
self-driver case has no TCC measurement.
...
helpers. TCC measurements require explicit authorization; other
...
Generated tools, logs, and results stay in `build/perf/`; baseline data lives
here.
