...
#define _fcprimepy _cprimepy
#define _fcprimemp _cprimemp
...
#define _tclen(_pc) (1)
#define _cprimepy(_pc1,_cpc2) ((*(_pc1) = *(_cpc2)))
#define _cprimemp(_cpc1,_cpc2) ((*(_cpc1))-(*(_cpc2)))
...
#define _cprimepy _mbccpy
#define _cprimepy_l _mbccpy_l
#else
  ...
  _CRTIMP void __cdecl _cprimepy(char *_DstCh,const char *_SrcCh);
...
#define _cprimemp(_cp1,_cp2) _tcsnccmp(_cp1,_cp2,1)
...
#define _tclen(_pc) (1)
#define _cprimepy(_pc1,_cpc2) (*(_pc1) = *(_cpc2))
#define _cprimemp(_cpc1,_cpc2) (((unsigned char)*(_cpc1))-((unsigned char)*(_cpc2)))
