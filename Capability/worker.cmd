...
rem
rem Three machines share one branch. This clone is the Capability arm of a
rem multi-machine loop in which other clones run the Compatibility and Cost
...
rem src/lib/libcprime1.a, src/scripts/*.exe, Capability/tests/test.exe - are
