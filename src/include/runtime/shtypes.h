/* Shell data declarations from the bundled mingw-w64 shtypes.h.
   RPC wire procedures are not required for the in-process shell API. */
#ifndef _CPC_SHTYPES_H
#define _CPC_SHTYPES_H
#include <windows.h>
#include <guiddef.h>
