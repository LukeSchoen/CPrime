...
Scope:
- Minimal, standalone reproducers for the open C++17 gaps. Compatibility\tests\CPP17-REMAINING.md
...
- Compatibility\tests\test.exe -Suite features/Cpp17Gaps -Select test_clamp.cpp
