...
#define _WSTRING_DEFINED
  ...
  errno_t __cdecl wcscpy_s(wchar_t *_Dest, size_t _SizeInWords, const wchar_t *_Source);
  size_t __cdecl wcscspn(const wchar_t *_Str,const wchar_t *_Control);
  size_t __cdecl wcslen(const wchar_t *_Str);
  size_t __cdecl wcsnlen(const wchar_t *_Src,size_t _MaxCount);
  wchar_t *__cdecl wcsncat(wchar_t *_Dest,const wchar_t *_Source,size_t _Count);
  errno_t __cdecl wcscat_s(wchar_t *_Dest, size_t _SizeInWords, const wchar_t *_Source);
  int __cdecl wcsncmp(const wchar_t *_Str1,const wchar_t *_Str2,size_t _MaxCount);
  wchar_t *__cdecl wcsncpy(wchar_t *_Dest,const wchar_t *_Source,size_t _Count);
  errno_t __cdecl wcsncpy_s(wchar_t *_Dest, size_t _SizeInWords, const wchar_t *_Source, size_t _Count);
