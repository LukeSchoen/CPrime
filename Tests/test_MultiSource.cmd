...
"%COMPILER%" %RUNTIME_ARGS% "%A_SRC%" "%MAIN_SRC%" -o "%WORK_DIR%\whole.exe" >"%WORK_DIR%\whole.out" 2>&1
...
"%COMPILER%" %RUNTIME_ARGS% -c "%A_SRC%" -o "%WORK_DIR%\a.o" >"%WORK_DIR%\compile_a.out" 2>&1
if errorlevel 1 (
  echo FAIL header inline member object compile a.cpp.
  type "%WORK_DIR%\compile_a.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%MAIN_SRC%" -o "%WORK_DIR%\main.o" >"%WORK_DIR%\compile_main.out" 2>&1
if errorlevel 1 (
  echo FAIL header inline member object compile main.cpp.
  type "%WORK_DIR%\compile_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\a.o" "%WORK_DIR%\main.o" -o "%WORK_DIR%\linked.exe" >"%WORK_DIR%\link.out" 2>&1
...
"%COMPILER%" %RUNTIME_ARGS% -c "%TEMPLATE_A_SRC%" -o "%WORK_DIR%\template_a.o" >"%WORK_DIR%\compile_template_a.out" 2>&1
if errorlevel 1 (
  echo FAIL header template inline member object compile a.cpp.
  type "%WORK_DIR%\compile_template_a.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%TEMPLATE_MAIN_SRC%" -o "%WORK_DIR%\template_main.o" >"%WORK_DIR%\compile_template_main.out" 2>&1
if errorlevel 1 (
  echo FAIL header template inline member object compile main.cpp.
  type "%WORK_DIR%\compile_template_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\template_a.o" "%WORK_DIR%\template_main.o" -o "%WORK_DIR%\template_linked.exe" >"%WORK_DIR%\link_template.out" 2>&1
...
"%COMPILER%" %RUNTIME_ARGS% -c "%OUT_CLASS_A_SRC%" -o "%WORK_DIR%\out_class_a.o" >"%WORK_DIR%\compile_out_class_a.out" 2>&1
if errorlevel 1 (
  echo FAIL out-of-class template member object compile a.cpp.
  type "%WORK_DIR%\compile_out_class_a.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%OUT_CLASS_MAIN_SRC%" -o "%WORK_DIR%\out_class_main.o" >"%WORK_DIR%\compile_out_class_main.out" 2>&1
if errorlevel 1 (
  echo FAIL out-of-class template member object compile main.cpp.
  type "%WORK_DIR%\compile_out_class_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\out_class_a.o" "%WORK_DIR%\out_class_main.o" -o "%WORK_DIR%\out_class_linked.exe" >"%WORK_DIR%\link_out_class.out" 2>&1
...
"%COMPILER%" %RUNTIME_ARGS% -c "%TEMPLATE_FUNC_A_SRC%" -o "%WORK_DIR%\template_func_a.o" >"%WORK_DIR%\compile_template_func_a.out" 2>&1
if errorlevel 1 (
  echo FAIL header template function object compile a.cpp.
  type "%WORK_DIR%\compile_template_func_a.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%TEMPLATE_FUNC_MAIN_SRC%" -o "%WORK_DIR%\template_func_main.o" >"%WORK_DIR%\compile_template_func_main.out" 2>&1
if errorlevel 1 (
  echo FAIL header template function object compile main.cpp.
  type "%WORK_DIR%\compile_template_func_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\template_func_a.o" "%WORK_DIR%\template_func_main.o" -o "%WORK_DIR%\template_func_linked.exe" >"%WORK_DIR%\link_template_func.out" 2>&1
...
"%COMPILER%" %RUNTIME_ARGS% -c "%FRIEND_A_SRC%" -o "%WORK_DIR%\friend_a.o" >"%WORK_DIR%\compile_friend_a.out" 2>&1
if errorlevel 1 (
  echo FAIL header friend definition object compile a.cpp.
  type "%WORK_DIR%\compile_friend_a.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%FRIEND_MAIN_SRC%" -o "%WORK_DIR%\friend_main.o" >"%WORK_DIR%\compile_friend_main.out" 2>&1
if errorlevel 1 (
  echo FAIL header friend definition object compile main.cpp.
  type "%WORK_DIR%\compile_friend_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\friend_a.o" "%WORK_DIR%\friend_main.o" -o "%WORK_DIR%\friend_linked.exe" >"%WORK_DIR%\link_friend.out" 2>&1
if errorlevel 1 (
...
"%COMPILER%" %RUNTIME_ARGS% -c "%LIFE_SRC%" -o "%WORK_DIR%\external_lifecycle.o" >"%WORK_DIR%\compile_lifecycle.out" 2>&1
if errorlevel 1 (
  echo FAIL external lifecycle object compile.
  type "%WORK_DIR%\compile_lifecycle.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%LIFE_MAIN_SRC%" -o "%WORK_DIR%\external_lifecycle_main.o" >"%WORK_DIR%\compile_lifecycle_main.out" 2>&1
if errorlevel 1 (
  echo FAIL external lifecycle main object compile.
  type "%WORK_DIR%\compile_lifecycle_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\external_lifecycle.o" "%WORK_DIR%\external_lifecycle_main.o" -o "%WORK_DIR%\external_lifecycle.exe" >"%WORK_DIR%\link_lifecycle.out" 2>&1
if errorlevel 1 (
...
"%COMPILER%" %RUNTIME_ARGS% -c "%DEFAULT_CTOR_SRC%" -o "%WORK_DIR%\default_ctor.o" >"%WORK_DIR%\compile_default_ctor.out" 2>&1
if errorlevel 1 (
  echo FAIL default-argument constructor object compile.
  type "%WORK_DIR%\compile_default_ctor.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%DEFAULT_CTOR_MAIN_SRC%" -o "%WORK_DIR%\default_ctor_main.o" >"%WORK_DIR%\compile_default_ctor_main.out" 2>&1
if errorlevel 1 (
  echo FAIL default-argument constructor main compile.
  type "%WORK_DIR%\compile_default_ctor_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\default_ctor.o" "%WORK_DIR%\default_ctor_main.o" -o "%WORK_DIR%\default_ctor.exe" >"%WORK_DIR%\link_default_ctor.out" 2>&1
if errorlevel 1 (
...
"%COMPILER%" %RUNTIME_ARGS% -c "%DEFAULT_ASSIGN_A_SRC%" -o "%WORK_DIR%\default_assign_a.o" >"%WORK_DIR%\compile_default_assign_a.out" 2>&1
if errorlevel 1 (
  echo FAIL defaulted assignment object compile a.cpp.
  type "%WORK_DIR%\compile_default_assign_a.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%DEFAULT_ASSIGN_MAIN_SRC%" -o "%WORK_DIR%\default_assign_main.o" >"%WORK_DIR%\compile_default_assign_main.out" 2>&1
if errorlevel 1 (
  echo FAIL defaulted assignment main compile.
  type "%WORK_DIR%\compile_default_assign_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\default_assign_a.o" "%WORK_DIR%\default_assign_main.o" -o "%WORK_DIR%\default_assign.exe" >"%WORK_DIR%\link_default_assign.out" 2>&1
if errorlevel 1 (
...
"%COMPILER%" %RUNTIME_ARGS% -c "%SRC_DIR%\header_implicit_lifecycle_a.cpp" -o "%WORK_DIR%\implicit_lifecycle_a.o" >"%WORK_DIR%\implicit_lifecycle_a.out" 2>&1
if errorlevel 1 (
  type "%WORK_DIR%\implicit_lifecycle_a.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% -c "%SRC_DIR%\header_implicit_lifecycle_main.cpp" -o "%WORK_DIR%\implicit_lifecycle_main.o" >"%WORK_DIR%\implicit_lifecycle_main.out" 2>&1
if errorlevel 1 (
  type "%WORK_DIR%\implicit_lifecycle_main.out"
  goto fail
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\implicit_lifecycle_a.o" "%WORK_DIR%\implicit_lifecycle_main.o" -o "%WORK_DIR%\implicit_lifecycle.exe" >"%WORK_DIR%\implicit_lifecycle_link.out" 2>&1
if errorlevel 1 (
...
for %%S in (language_linkage_a.cpp language_linkage_c.c language_linkage_main.cpp) do (
  "%COMPILER%" %RUNTIME_ARGS% -Werror -c "%SRC_DIR%\%%S" -o "%WORK_DIR%\%%S.o" >"%WORK_DIR%\%%S.out" 2>&1
  if errorlevel 1 (
    type "%WORK_DIR%\%%S.out"
    goto fail
  )
)
"%COMPILER%" %RUNTIME_ARGS% "%WORK_DIR%\language_linkage_a.cpp.o" "%WORK_DIR%\language_linkage_c.c.o" "%WORK_DIR%\language_linkage_main.cpp.o" -o "%WORK_DIR%\language_linkage.exe" >"%WORK_DIR%\language_linkage.out" 2>&1
if errorlevel 1 (
