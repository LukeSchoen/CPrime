     ...
     DEF(TOK_CO_AWAIT, "co_await")
     DEF(TOK_CO_YIELD, "co_yield")
     DEF(TOK_CO_RETURN, "co_return")
     DEF(TOK_CPC_COROUTINE_PROMISE, "__cpc_coroutine_promise")
     DEF(TOK_TRY, "try")
     DEF(TOK_CATCH, "catch")
 DEF(TOK_THROW, "throw")
 ...
 DEF(TOK_CXX_BASE_CTOR_SPLIT, "__builtin_cpc_base_ctor_split")
     ...
     DEF(TOK_COMPLEX3, "__complex")
     DEF(TOK_REALPART, "__real__")
     DEF(TOK_IMAGPART, "__imag__")
     DEF(TOK_SHORT, "short")
     DEF(TOK_LONG, "long")
     ...
     DEF(TOK_UNDERLYING_TYPE, "__underlying_type")
     ...
     DEF(TOK___PRETTY_FUNCTION__, "__PRETTY_FUNCTION__")
     ...
     /* Complex builtins take the real part, the imaginary part and the
        complex conjugate ([GNU] Complex Numbers). */
     ...
     DEF(TOK_builtin_clzg, "__builtin_clzg")
     DEF(TOK_builtin_ctzg, "__builtin_ctzg")
     DEF(TOK_builtin_clrsbg, "__builtin_clrsbg")
     DEF(TOK_builtin_ffsg, "__builtin_ffsg")
     DEF(TOK_builtin_parityg, "__builtin_parityg")
     DEF(TOK_builtin_popcountg, "__builtin_popcountg")
